...
const getCorporateActions = (): Promise<AxiosResponse<Array<CorporateAction>>> => {
  return axios.get(serviceUrl, {
    cancelToken: source.token
  });
}

const getCorporateAction = (id: number): Promise<AxiosResponse<CorporateAction>> => {
  return axios.get(serviceUrl + '/' + id, {
    cancelToken: source.token
  });
}

const putCorporateAction = (corporateAction: CorporateAction): Promise<AxiosResponse<CorporateAction>> => {
  return axios.put(serviceUrl, corporateAction, {
    cancelToken: source.token
  });
}

const postCorporateAction = (corporateAction: CorporateAction): Promise<AxiosResponse<CorporateAction>> => {
